...
export const AuthButton = styled.button<{ color?: string; margin?: string }>`
  ...
  background: ${({ color }) => color || `linear-gradient(135deg, ${theme.colors.primary}, ${theme.colors.primaryHover})`};
...
export const LocationButton = styled.button`
  ...
  transition: border-color ${theme.motion.base}, transform ${theme.motion.base};
